      ...
      <section>
        <div className="mx-auto max-w-c-1390 px-4 md:px-8 2xl:px-0">
          ...
          <SectionHeader
            headerInfo={{
              title: `EXCHANGES`,
              subtitle: `Easilly Exchange Your Puppies in the best Exchanges`,
              description: ``,
            }}
          />
